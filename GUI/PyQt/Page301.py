...
def ShowPage(self):
    self.ui.Main_stackedWidget.setCurrentWidget(self.ui.Stimulus_Page)
...
def ChangeChirpParameter(self):
    ...
    if self.ChirpIndex == 0:
        ...
        self.ui.Chirp_StartFrequency_Value.setStyleSheet("background-color: rgb" + str(tuple(self.ui.DarkSolarized[2])) + ";\n"
                                                         "border: 2px solid rgb" + str(tuple(self.ui.DarkSolarized[14])) + ";\n"
                                                         )
        self.ui.Chirp_EndFrequency_Value.setEnabled(True)
        self.ui.Chirp_EndFrequency_Value.setStyleSheet("background-color: rgb" + str(tuple(self.ui.DarkSolarized[2])) + ";\n"
                                                       "border: 2px solid rgb" + str(tuple(self.ui.DarkSolarized[14])) + ";\n"
                                                       )
    ...
    if self.ChirpIndex == 2:
        ...
        self.ui.Chirp_Frequency_Value.setStyleSheet("background-color: rgb" + str(tuple(self.ui.DarkSolarized[2])) + ";\n"
                                                    "border: 2px solid rgb" + str(tuple(self.ui.DarkSolarized[14])) + ";\n"
                                                    )
...
class StimulusGenerator():
    ...
    def SetGraph(self):
        ...
        self.ui.StimulusGenerator_Oscilloscope_widget.setBackground(self.ui.DarkSolarized[0])
    ...
    def IntensitySteps(self):
        ...
        for i in range(self.nStep):
            ...
            self.ui.StimulusGenerator_Oscilloscope_widget.plot(self.XStep, self.xStim[i*self.StepDur : (i+1)*self.StepDur], pen=(self.ui.DarkSolarized[3]))
    ...
    def SineWave(self):
        ...
        self.ui.StimulusGenerator_Oscilloscope_widget.clear()
        self.SineCurve = self.ui.StimulusGenerator_Oscilloscope_widget.plot(self.xStim, self.nStim, pen=(self.ui.DarkSolarized[3]))
    ...
    def ChirpWave(self):
        ...
        self.ui.StimulusGenerator_Oscilloscope_widget.clear()
        self.SineCurve = self.ui.StimulusGenerator_Oscilloscope_widget.plot(self.XStim, self.nStim,pen=(self.ui.DarkSolarized[3]))
        self.ChirpCurve = self.ui.StimulusGenerator_Oscilloscope_widget.plot(self.XStim, self.Modulation,pen=(self.ui.DarkSolarized[7]))
